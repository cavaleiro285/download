<?php
$failure = "O URL do vídeo é inválido
!<br/>";
$hd = "";
$sd = "";
$title = "";
...
Miniatura</b></p><p class="text-center"><img class="img-thumbnail" src="https://graph.facebook.com/<?php echo $id; ?>/picture"></p>
      		</div>
		<div class="col-md-6">
                  <p class="text-center"><b>Informação</b></p>
